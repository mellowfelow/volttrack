...
export const PRODUCTS = [
  // ---- SUR-RON ----
  { slug: 'sur-ron-light-bee-x', name: 'Sur-Ron Light Bee X 2026', titleName: 'Light Bee X', h1: 'Surron Light Bee X', price: 4999, brand: 'sur-ron', category: 'adult-electric-dirt-bikes', badge: 'Bestseller', images: ['sur-ron-light-bee-x.webp'], specs: { power: '10 kW peak', topSpeed: '47 mph', range: '40 mi', weight: '110 lb', battery: '72V 35Ah', modes: '4', roadLegal: 'No (off-road / OHV)', age: '14+' },
  ...
  { slug: 'sur-ron-ultra-bee-hp', name: 'Sur-Ron Ultra Bee HP 2026', titleName: 'Ultra Bee HP', h1: 'Surron Ultra Bee', price: 6499, brand: 'sur-ron', category: 'adult-electric-dirt-bikes', badge: 'Flagship', images: ['sur-ron-ultra-bee-hp.webp'], specs: { power: '21 kW peak', topSpeed: '56 mph', range: '55 mi', weight: '187 lb', battery: '74V 60Ah', modes: '4', roadLegal: 'No (off-road / OHV)', age: '16+' },
  ...
  { slug: 'sur-ron-hyper-bee', name: 'Sur-Ron Hyper Bee', h1: 'Surron Hyper Bee', price: 3699, brand: 'sur-ron', category: 'adult-electric-dirt-bikes', badge: 'Lightest Sur-Ron', images: ['sur-ron-hyper-bee.webp'], specs: { power: '8 kW peak', topSpeed: '50 mph', range: '50 mi', weight: '86 lb', battery: '58V 22.5Ah', modes: '4', roadLegal: 'No (off-road / OHV)', age: '12+' },
  ...
  { slug: 'sur-ron-storm-bee', name: 'Sur-Ron Storm Bee', h1: 'Surron Storm Bee', price: 8499, brand: 'sur-ron', category: 'electric-motocross-bikes', badge: 'Full-size MX', images: ['sur-ron-storm-bee.webp'], specs: { power: '22.5 kW peak', topSpeed: '68 mph', range: '75 mi', weight: '265 lb', battery: '84V 55Ah', modes: '3', roadLegal: 'No (closed-course)', age: '18+' },
  ...
  { slug: 'sur-ron-ultra-bee-mx', name: 'Sur-Ron Ultra Bee MX 2026', titleName: 'Ultra Bee MX', h1: 'Sur Ron Ultra Bee MX', price: 6799, brand: 'sur-ron', category: 'electric-motocross-bikes', badge: '', images: ['sur-ron-ultra-bee-mx.webp'], specs: { power: '21 kW peak', topSpeed: '56 mph', range: '55 mi', weight: '185 lb', battery: '74V 60Ah', modes: '4', roadLegal: 'No (closed-course)', age: '16+' },
  ...
  // ---- TALARIA ----
  { slug: 'talaria-sting-r-mx4', name: 'Talaria Sting R MX4', h1: 'Talaria Sting R', price: 3735, brand: 'talaria', category: 'adult-electric-dirt-bikes', badge: 'Popular', images: ['talaria-sting-r-mx4.webp'], specs: { power: '8 kW peak', topSpeed: '53 mph', range: '50 mi', weight: '128 lb', battery: '60V 45Ah', modes: '4', roadLegal: 'No (off-road / OHV)', age: '14+' },
  ...
  { slug: 'talaria-sting-mx5-pro', name: 'Talaria Sting MX5 Pro', titleName: 'Sting MX5 Pro', h1: 'Talaria MX5', price: 4800, brand: 'talaria', category: 'adult-electric-dirt-bikes', badge: '', images: ['talaria-sting-mx5-pro.webp'], specs: { power: '8 kW peak', topSpeed: '55 mph', range: '55 mi', weight: '130 lb', battery: '72V 40Ah Samsung 50S', modes: '4', roadLegal: 'No (off-road / OHV)', age: '16+' },
  ...
  { slug: 'talaria-sting-xxx', name: 'Talaria Sting XXX', h1: 'Talaria XXX Pro', price: 6649, brand: 'talaria', category: 'electric-motocross-bikes', badge: '', images: ['talaria-sting-xxx.webp'], specs: { power: '10.5 kW peak', topSpeed: '60 mph', range: '55 mi', weight: '132 lb', battery: '60V frame-spine', modes: '4', roadLegal: 'No (closed-course)', age: '16+' },
  ...
  { slug: 'talaria-sting-mx3', name: 'Talaria Sting MX3', h1: 'Talaria MX3', price: 3390, brand: 'talaria', category: 'adult-electric-dirt-bikes', tags: ['cheap-electric-dirt-bikes'], badge: 'Value', images: ['talaria-sting-mx3.webp'], specs: { power: '6 kW peak', topSpeed: '47 mph', range: '40 mi', weight: '110 lb', battery: '60V 38.4Ah', modes: '4', roadLegal: 'No (off-road / OHV)', age: '14+' },
  ...
  { slug: 'talaria-komodo', name: 'Talaria Komodo (TL6000)', titleName: 'Talaria Komodo', h1: 'Talaria Komodo', price: 5999, brand: 'talaria', category: 'electric-trail-bikes', badge: 'New', images: ['talaria-komodo.webp'], specs: { power: '32 kW peak', topSpeed: '66 mph', range: '70 mi', weight: '203 lb', battery: '96V 45Ah', modes: '4', roadLegal: 'No (off-road / OHV)', age: '16+' },
  ...
  { slug: 'talaria-x3-pro', name: 'Talaria X3 Pro', h1: 'Talaria X3 Pro', price: 5299, brand: 'talaria', category: 'adult-electric-dirt-bikes', badge: 'New', images: ['talaria-x3-pro.webp'], specs: { power: '8 kW peak', topSpeed: '53 mph', range: '50 mi', weight: '128 lb', battery: '60V 45Ah', modes: '4', roadLegal: 'No (off-road / OHV)', age: '14+' },
  ...
  { slug: 'stark-varg-ex', name: 'Stark Varg EX', h1: 'Stark Varg EX', price: 12900, brand: 'stark-future', category: 'electric-trail-bikes', tags: ['street-legal-electric-bikes'], badge: 'Street-legal enduro', images: ['stark-varg-ex.webp'],
  ...
  { slug: 'stark-varg-sm', name: 'Stark Varg SM', h1: 'Stark Varg SM', price: 12900, brand: 'stark-future', category: 'electric-trail-bikes', tags: ['street-legal-electric-bikes'], badge: 'Supermoto', images: ['stark-varg-sm.webp'],
  ...
  // ---- KTM ----
  { slug: 'ktm-sx-e-5', name: 'KTM SX-E 5 2026', h1: 'KTM E5', price: 5449, brand: 'ktm', category: 'youth-electric-dirt-bikes', badge: '', images: ['ktm-sx-e-5.webp'], specs: { power: '5 kW (water-cooled)', topSpeed: 'Adjustable', range: '~2 hrs', weight: '87 lb', battery: '907 Wh', modes: '6', roadLegal: 'No (closed-course)', age: '4–12' },
  ...
  { slug: 'ktm-sx-e-2', name: 'KTM SX-E 2 2025', h1: 'KTM E2', price: 2249, brand: 'ktm', category: 'youth-electric-dirt-bikes', tags: ['cheap-electric-dirt-bikes'], badge: 'Entry', images: ['ktm-sx-e-2.webp'], specs: { power: '1.8 kW hub motor', topSpeed: 'Adjustable', range: '~100 min', weight: '70 lb', battery: 'Integrated', modes: '3', roadLegal: 'No (closed-course)', age: '3–6' },
  ...
  // ---- STACYC ----
  { slug: 'stacyc-12e-drive', name: 'STACYC 12eDRIVE', h1: 'STACYC 12', price: 649, brand: 'stacyc', category: 'youth-electric-dirt-bikes', badge: 'Ages 3–5', images: ['stacyc-12e-drive.webp'], specs: { power: '20V drive', topSpeed: '~7.5 mph', range: '30–60 min', weight: '17 lb', battery: '20V Li-ion (quick-swap)', modes: '3', roadLegal: 'No (off-road)', age: '3–5' },
  ...
  { slug: 'stacyc-16e-drive', name: 'STACYC 16eDRIVE Brushless', titleName: 'STACYC 16eDRIVE', h1: 'STACYC 16', price: 899, brand: 'stacyc', category: 'youth-electric-dirt-bikes', badge: 'Ages 4–7', images: ['stacyc-16e-drive.webp'], specs: { power: '20V brushless', topSpeed: '~9 mph', range: '30–60 min', weight: '19 lb', battery: '20V Li-ion (quick-swap)', modes: '3', roadLegal: 'No (off-road)', age: '4–7' },
  ...
  { slug: 'stacyc-18e-drive', name: 'STACYC 18eDRIVE', h1: 'STACYC 18', price: 1049, brand: 'stacyc', category: 'youth-electric-dirt-bikes', badge: 'Ages 5–8', images: ['stacyc-18e-drive.webp'], specs: { power: '20V drive', topSpeed: '13 mph', range: '30–60 min', weight: '19 lb', battery: '20V Li-ion (quick-swap)', modes: '3', roadLegal: 'No (off-road)', age: '5–8' },
  ...
  { slug: 'stacyc-20e-drive', name: 'STACYC 20eDRIVE', h1: 'STACYC 20', price: 1199, brand: 'stacyc', category: 'youth-electric-dirt-bikes', badge: 'Ages 6–10', images: ['stacyc-20e-drive.webp'], specs: { power: '20V drive', topSpeed: '17 mph', range: '30–60 min', weight: '21 lb', battery: '20V Li-ion (quick-swap)', modes: '3', roadLegal: 'No (off-road)', age: '6–10' },
  ...
  // ---- RAZOR ----
  { slug: 'razor-mx650', name: 'Razor MX650 Dirt Rocket', titleName: 'Razor MX650', h1: 'Razor MX650 Electric Dirt Bike', price: 599, brand: 'razor', category: 'youth-electric-dirt-bikes', tags: ['cheap-electric-dirt-bikes'], badge: 'Fastest Razor', images: ['razor-mx650.webp'], specs: { power: '650 W', topSpeed: '17 mph', range: '~10 mi', weight: '98 lb', battery: '36V SLA', modes: '1', roadLegal: 'No (off-road)', age: '16+' },
  ...
  // ---- E-RIDE PRO ----
  { slug: 'e-ride-pro-mini', name: 'E-Ride Pro Mini', h1: 'E Ride Pro Mini', price: 2499, brand: 'e-ride-pro', category: 'electric-pit-bikes', tags: ['cheap-electric-dirt-bikes'], badge: 'Pit bike', images: ['e-ride-pro-mini.webp'], specs: { power: '~4 kW peak', topSpeed: '~30 mph', range: '~40 mi', weight: '~110 lb', battery: '60V', modes: '3', roadLegal: 'No (off-road)', age: '14+' },
  ...
  { slug: 'e-ride-pro-ss', name: 'E-Ride Pro SS', h1: 'E Ride Pro SS 2.0', price: 3799, brand: 'e-ride-pro', category: 'adult-electric-dirt-bikes', badge: 'Best value', images: ['e-ride-pro-ss.webp'],
    variants: [
  ...
  { slug: 'talaria-x3', titleName: 'Talaria X3', h1: 'Talaria X3', name: 'Talaria X3', price: 4799, brand: 'talaria', category: 'adult-electric-dirt-bikes', badge: 'Popular', images: ['talaria-x3.webp'], specs: { power: '8 kW peak', topSpeed: '~53 mph', range: '~55 mi', weight: '~121 lb', battery: '40Ah frame-distributed', modes: '4', roadLegal: 'No (off-road / OHV)', age: '14+' },
  ...
  { slug: 'talaria-dragon', titleName: 'Talaria Dragon', h1: 'Talaria Dragon', name: 'Talaria Dragon', price: 7649, brand: 'talaria', category: 'electric-trail-bikes', badge: 'Flagship', images: ['talaria-dragon.webp'], specs: { power: '28 kW peak', topSpeed: '70 mph', range: '93 mi', weight: '~220 lb', battery: '88V 58.5Ah', modes: '4', roadLegal: 'No (off-road / OHV)', age: '18+' },
  ...
  { slug: 'stark-varg-mx', titleName: 'Stark Varg MX', h1: 'Stark Varg MX', name: 'Stark Varg MX 1.2', price: 10490, brand: 'stark-future', category: 'electric-motocross-bikes', badge: 'Race spec', images: ['stark-varg-mx.webp'],
    variants: [
  ...
  { slug: 'e-ride-pro-s', titleName: 'E-Ride Pro S', h1: 'E Ride Pro S', name: 'E-Ride Pro S', price: 3299, brand: 'e-ride-pro', category: 'adult-electric-dirt-bikes', badge: '', images: ['e-ride-pro-s.webp'],
    variants: [
  ...
  { slug: 'e-ride-pro-sr', titleName: 'E-Ride Pro SR', h1: 'E Ride Pro SR', name: 'E-Ride Pro SR', price: 4799, brand: 'e-ride-pro', category: 'adult-electric-dirt-bikes', badge: 'Flagship', images: ['e-ride-pro-sr.webp'], specs: { power: '25 kW peak', topSpeed: '62–70 mph', range: '~100 mi', weight: '~165 lb', battery: '72V 50Ah', modes: '3 + Bluetooth tuning', roadLegal: 'No (off-road / OHV)', age: '18+' },
  ...
  { slug: 'zero-fx', titleName: 'Zero FX', h1: 'Zero FX Electric Dirt Bike', name: 'Zero FX 2025', price: 12495, brand: 'zero', category: 'electric-trail-bikes', badge: 'Premium', images: ['zero-fx.webp'], specs: { power: '34 kW peak', topSpeed: '~85 mph', range: '~91 mi city', weight: '~298 lb', battery: '7.2 kWh', modes: '3', roadLegal: 'Dual-sport — state dependent', age: '18+' },
  ...
  { slug: 'razor-mx500', titleName: 'Razor MX500', h1: 'Razor MX500 Dirt Rocket', name: 'Razor MX500 Dirt Rocket', price: 459, brand: 'razor', category: 'youth-electric-dirt-bikes', tags: ['cheap-electric-dirt-bikes'], badge: '', images: ['razor-mx500.webp'], specs: { power: '500 W', topSpeed: '15 mph', range: '~40 min', weight: '98 lb', battery: '36V SLA', modes: '1', roadLegal: 'No (off-road)', age: '13–16' },
  ...
  // ---- ALTIS ----
  { slug: 'altis-sigma', name: 'Altis Sigma', h1: 'Altis Sigma', price: 3999, brand: 'altis', category: 'adult-electric-dirt-bikes', badge: '98V performance', images: ['altis-sigma.webp'],
    variants: [
  ...
  { slug: 'altis-delta', name: 'Altis Delta', h1: 'Altis Delta E Bike', price: 2799, brand: 'altis', category: 'electric-pit-bikes', tags: ['cheap-electric-dirt-bikes'], badge: '', images: ['altis-delta.webp'], specs: { power: '13 kW peak', topSpeed: '62 mph', range: '~45 mi', weight: '~130 lb', battery: '72V', modes: '3', roadLegal: 'No (off-road / OHV)', age: '14+' },
  ...
  // ---- ZERO ----
  { slug: 'zero-xb', name: 'Zero XB 2026', h1: 'Zero XB Electric Dirt Bike', price: 5095, brand: 'zero', category: 'electric-trail-bikes', badge: 'New 2026', images: ['zero-xb.webp'], specs: { power: '~11 kW', topSpeed: '~55 mph', range: '~50 mi', weight: '~180 lb', battery: '~3.0 kWh', modes: '3', roadLegal: 'No (off-road / OHV)', age: '16+' },
  ...
  { slug: 'zero-xe', name: 'Zero XE 2026', h1: 'Zero XE Electric Dirt Bike', price: 7395, brand: 'zero', category: 'electric-trail-bikes', badge: '', images: ['zero-xe.webp'], specs: { power: '15.5 kW', topSpeed: '~60 mph', range: '65 mi', weight: '~230 lb', battery: '4.3 kWh', modes: '3', roadLegal: 'No (off-road / OHV)', age: '16+' },
  ...
  { slug: 'ktm-sx-e-3', name: 'KTM SX-E 3 2025', h1: 'KTM SX E 3 Electric Dirt Bike', price: 3649, brand: 'ktm', category: 'youth-electric-dirt-bikes', badge: '', images: ['ktm-sx-e-3.webp'], specs: { power: '~3 kW', topSpeed: 'Adjustable', range: '~2 hrs', weight: '~80 lb', battery: 'Integrated Li-ion', modes: '6', roadLegal: 'No (closed-course)', age: '4–10' },
  ...
  { slug: 'ktm-freeride-exc', name: 'KTM Freeride E-XC 2025', h1: 'KTM Freeride E-XC', price: 11499, brand: 'ktm', category: 'electric-trail-bikes', badge: 'Full-size trail', images: ['ktm-freeride-exc.webp'], specs: { power: '19.2 kW', topSpeed: '~50 mph', range: '2–3 hrs trail riding', weight: '247 lb', battery: '5.5 kWh', modes: '3', roadLegal: 'No (off-road / OHV)', age: '16+' },
  ...
  { slug: 'razor-mx125', name: 'Razor MX125 Dirt Rocket', titleName: 'Razor MX125', h1: 'Razor MX125 Electric Dirt Bike', price: 229, brand: 'razor', category: 'youth-electric-dirt-bikes', tags: ['cheap-electric-dirt-bikes'], badge: 'Entry', images: ['razor-mx125.webp'], specs: { power: '125 W', topSpeed: '8 mph', range: '~30 min', weight: '38 lb', battery: '12V SLA', modes: '1', roadLegal: 'No (off-road)', age: '7–10' },
  ...
  // ---- GASGAS ----
  { slug: 'gasgas-mc-e-2', name: 'GasGas MC-E 2 2025', h1: 'GasGas E2', price: 2249, brand: 'gasgas', category: 'youth-electric-dirt-bikes', tags: ['cheap-electric-dirt-bikes'], badge: 'Entry', images: ['gasgas-mc-e-2.webp'], specs: { power: '1.8 kW hub motor', topSpeed: 'Adjustable', range: '~100 min', weight: '~70 lb', battery: 'Integrated Li-ion', modes: '3', roadLegal: 'No (closed-course)', age: '3–7' },
  ...
  { slug: 'gasgas-mc-e-5', name: 'GasGas MC-E 5 2025', h1: 'GasGas Electric Bike', price: 5449, brand: 'gasgas', category: 'youth-electric-dirt-bikes', badge: 'Race ready', images: ['gasgas-mc-e-5.webp'], specs: { power: '5 kW (water-cooled)', topSpeed: 'Adjustable', range: '~2 hrs', weight: '~87 lb', battery: '907 Wh (fast-swap)', modes: '6', roadLegal: 'No (closed-course)', age: '4–12' },
  ...
  // ---- SEGWAY ----
  { slug: 'segway-xaber-300', name: 'Segway Xaber 300 2026', titleName: 'Segway Xaber 300', h1: 'Segway Xaber 300', price: 5299, brand: 'segway', category: 'adult-electric-dirt-bikes', badge: 'New 2026', images: ['segway-xaber-300.webp'], specs: { power: '21 kW', topSpeed: '60 mph', range: '62 mi', weight: '~240 lb', battery: '72V 44Ah Samsung 50S', modes: '4', roadLegal: 'No (off-road / OHV)', age: '16+' },
  ...
  { slug: 'segway-xyber', titleName: 'Segway Xyber', h1: 'Segway Xyber', name: 'Segway Xyber', price: 0, enquire: true, brand: 'segway', category: 'adult-electric-dirt-bikes', badge: 'Contact for pricing', images: ['segway-xyber.webp'], specs: { power: 'Contact us', topSpeed: 'Contact us', range: 'Contact us', weight: 'Contact us', battery: 'Contact us', modes: 'Contact us', roadLegal: 'No (off-road / OHV)', age: '16+' },
...
export const POSTS = [
  ...
  // Paragraphs may contain inline [text](/internal-link) markup (see Prose.jsx).
  {
    ...
    sections: [
      ...
      {
        h2: 'Should you wait for the Factory Edition?',
        paras: [
          'For most riders, no. The Factory Edition adds exclusivity and the highest factory tune, but the 80 HP Alpha models already deliver enormous performance, the same KYB suspension and Brembo brakes, and they are available to order now rather than on an unconfirmed timeline. Waiting on a bike with no confirmed US price or delivery date is a gamble on all three.',
          'The riders who should wait are collectors and racers who specifically want the limited edition and are willing to accept an open-ended timeline to get it. If that is you, register your interest so you are first in line when allocation firms up. If you just want the best Varg you can ride this season, buy an Alpha and enjoy it now — you can always add the Factory Edition later if it lives up to the hype.',
        ],
      },
    ],
    faqs: [
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'The verdict', paras: [
        'The Hyper Bee is the bike we most often recommend to riders who are not sure a full-size Sur-Ron is right for them. It removes the two things that intimidate newcomers — weight and unmanageable power — without feeling like a toy, and it does so at the lowest price of any adult Sur-Ron. That combination is rare and genuinely valuable.',
        'It will not be the last word for a heavy, aggressive rider chasing outright speed, and it does not have the Light Bee’s bottomless upgrade path. But as a bike to actually ride, learn on and enjoy — rather than a project to build — the Hyper Bee punches well above its price. For lighter adults, teens and anyone stepping up from a first bike, it is one of the easiest recommendations in the whole range.',
      ] },
    ],
    faqs: [
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'How the Varg compares on price', paras: [
        'Against gas 450 motocross bikes the Varg is priced in the same premium territory, but it changes the maths on running costs — no fuel, no oil, no top-ends. Against other electric dirt bikes it sits at the very top: a lightweight Sur-Ron or Talaria costs a third to a half as much. That gap is the honest reason most riders do not need a Varg, however good it is.',
        'What you are paying for is genuine race-winning performance and componentry that would cost a fortune to replicate through upgrades on a cheaper bike. If you race or ride at a high level, that is money well spent. If you ride trails at the weekend, it is more bike, and more money, than the riding calls for.',
      ] },
      { h2: 'Which Stark Varg should you buy?', paras: [
        'If you race or ride closed-course motocross, the MX is the one — it is the lightest, most focused Varg and the cheapest way in. If you want a street-legal enduro you can register and ride on trails and roads, the EX is your bike. If you want a supermoto for city and trail, the SM. Within each, the Alpha tune is worth the roughly $1,000 premium if the budget allows, but the Standard is far from slow.',
        'Whichever you choose, confirm the current figure with us before ordering — tariff conditions can move Stark Varg pricing, so every number here is an estimate rather than a locked quote.',
      ] },
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'Build quality and components', paras: [
        'The Komodo feels like a step up from the Sting range in more than just power. The 96V system and 45Ah pack are matched to suspension and brakes that can handle the extra speed and weight, so the bike stays composed when you push it. It is a genuine performance machine rather than a lightweight bike with a bigger battery bolted in.',
        'That said, like most bikes in this class it still benefits from the usual sensible checks — keeping the chain clean and lubed, watching brake pad wear, and confirming everything is torqued correctly after the first few rides. Electric drivetrains remove the engine servicing, but the chassis is still a dirt bike and rewards basic care.',
        'The 96V system is also worth understanding before you buy. Higher voltage delivers the strong, sustained power the Komodo is known for, but it means the pack and charger are specific to this bike rather than shared with the lighter 60V and 72V machines. Keep that in mind if you already own accessories for a Sting or Sur-Ron — you will be starting fresh on batteries and chargers.',
      ] },
      { h2: 'Komodo vs the lightweight class', paras: [
        'It is worth being clear about what the Komodo is not. If your riding is tight, slow and technical, a 203 lb mid-weight bike is more machine than you want, and a lighter option like the [Sur-Ron Hyper Bee](/product/sur-ron-hyper-bee/) or a Talaria Sting will be more fun and less tiring. The Komodo’s weight and power are assets on fast, open ground and a liability in a tight woods section.',
        'Where it shines is exactly where the lightweight bikes run out of legs: sustained speed, long climbs, and range that lets you ride all day. If that describes your local terrain, the Komodo is transformative. If it does not, spend less and buy lighter — the most expensive bike is not automatically the right one.',
      ] },
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'Electric vs gas for a 10 year old', paras: [
        'Parents often ask whether to start a child on electric or a small gas bike. For most families electric wins clearly at this age: there is no clutch or gears to master, the power is smooth and predictable, and selectable ride modes let you cap the speed precisely. A child can focus on balance, braking and body position without also wrestling a temperamental two-stroke.',
        'Electric is also quieter and lower-maintenance, which matters when you are the one running the pit. No premix, no fouled plugs, no cold-start drama — you charge it and go. When your rider is ready for more, they can step up within the electric range or move to gas with the fundamentals already in place.',
        'The quiet operation has a practical benefit too: you can ride in more places and at more times of day without upsetting neighbours, which for a lot of families is the difference between riding most weekends and barely riding at all. More seat time is what actually builds a young rider’s skill, so anything that removes friction from getting out is worth a lot.',
        'There is a safety angle as well. Because electric power is instant and smooth, a nervous child is not fighting a snatchy clutch or a two-stroke’s sudden powerband while also trying to stay upright. You set a gentle mode, they learn the fundamentals of balance and braking, and only then do you introduce more speed. That staged progression is far harder to manage on a peaky gas bike, which is a big part of why so many parents now start their kids on electric.',
      ] },
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'The used market', paras: [
        'If you are shopping used, the two brands behave differently. Used Sur-Rons are plentiful and hold strong prices, and because the parts ecosystem is so deep you can buy an older bike with confidence that anything worn can be replaced or upgraded. The trade-off is that you rarely find a bargain — demand keeps prices firm.',
        'Used Talarias can represent better value, especially newer models depreciating from a lower starting price, but the smaller parts network means you want to buy a clean example rather than a project. For either brand, our advice is the same: buy the best-condition bike you can afford, check the battery health, and factor in the cost of any upgrades you already know you want.',
      ] },
      { h2: 'What we would buy', paras: [
        'Put on the spot, here is how we would call it. First electric bike, tight budget, mostly stock riding: a Talaria Sting, likely the MX4. Planning to modify heavily and keep the bike for years: a Sur-Ron Light Bee X for the ecosystem. Want the most stock range and speed for the money: a Talaria Komodo. Lightest, most beginner-friendly option either brand makes: the Sur-Ron Hyper Bee.',
        'There is genuinely no wrong answer — both brands make bikes we are happy to sell and ride ourselves. The debate never settles because it is not really Sur-Ron versus Talaria; it is which bike fits your budget, your terrain and what you plan to do with it.',
        'One last piece of advice: do not buy on spec sheets alone. A bike that fits your body, suits your local trails and matches your appetite for tinkering will make you happier than one that wins a paper comparison. If you can, sit on both and picture your typical ride — and if you cannot, tell us your height, weight and where you ride, and we will point you honestly toward the one that fits.',
      ] },
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'Segway as a brand in dirt', paras: [
        'Some riders are surprised to see Segway making a serious dirt bike, associating the name with commuter scooters. But Segway Powersports is a substantial operation with real engineering behind it, and the Xaber 300 is the clearest statement yet that they are aiming at enthusiasts rather than the lifestyle market. The Samsung cells and Marzocchi suspension are not the choices of a company cutting corners.',
        'The X160 and X260 that came before were solid if unremarkable; the Xaber 300 is a genuine step up and a sign the brand is investing. For buyers that matters, because a manufacturer that keeps improving is more likely to support the bike with parts and updates down the line.',
      ] },
      { h2: 'What to know before you buy', paras: [
        'As with every bike in this class, the Xaber 300 is off-road / OHV use only — it is not street legal, and you should plan to ride it on private land or designated OHV areas with the correct registration. California riders should follow Vehicle Code Section 436.1. Confirm the current price with us before ordering, since tariff conditions can move it.',
        'If you are cross-shopping, the honest comparison is against the Sur-Ron Light Bee X and the mid-weight Talaria machines. The Xaber counters the Sur-Ron’s lightness and aftermarket with better stock componentry and more speed. Which matters more depends on whether you are a rider who upgrades or a rider who just wants a complete bike out of the crate.',
      ] },
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'Who should choose which', paras: [
        'For riders close to home, on private land or OHV parks, and especially for families with younger riders, electric is usually the better call — lower running costs, near-silent operation and minimal maintenance make it easy to ride often. For riders doing long backcountry days far from power, or those who value a deep used market and independent repair, gas still holds practical advantages.',
        'The good news is you no longer have to compromise much on performance either way. Modern electric dirt bikes match or beat comparable gas machines on acceleration and, increasingly, on range. The decision comes down to how and where you ride rather than whether electric can keep up — it can.',
      ] },
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'Resale and running costs', paras: [
        'Both bikes are cheap to run — pennies to charge, no fuel or oil, and only tyres, brakes, suspension and the chain to maintain. Where they differ is resale. The Sur-Ron’s strong used-market demand means a well-kept Light Bee X gives much of its purchase price back when you sell, which narrows the real cost gap against the cheaper E-Ride Pro over time.',
        'Factor that in if you expect to upgrade in a couple of years. The E-Ride Pro SS costs less up front, but the Sur-Ron’s stronger resale and deeper parts support can make it the more sensible long-term buy for a rider who churns through bikes or plans to sell on.',
      ] },
      { h2: 'The bottom line', paras: [
        'If you want the most speed and size per dollar and plan to ride largely stock, the E-Ride Pro SS is outstanding value. If you want the lighter, more refined ride, the deepest aftermarket and the strongest resale, the Sur-Ron Light Bee X justifies its premium. Both are genuinely good bikes — the right one depends on whether you are a value buyer or an ecosystem buyer.',
        'Still torn? Think about the five-year picture rather than the sticker price. If you plan to modify, sell on and buy again, the Sur-Ron ecosystem and resale tilt the maths its way. If you want to buy once, ride it as it comes and keep it simple, the E-Ride Pro gives you more bike today for less money — and that is a perfectly good reason to choose it.',
      ] },
    ],
    faqs: [
