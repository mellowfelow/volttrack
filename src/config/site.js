...
export const PRODUCTS = [
  { slug: 'sur-ron-light-bee-x', name: 'Sur-Ron Light Bee X 2025', price: 4999, brand: 'sur-ron', category: 'adult-electric-dirt-bikes', badge: 'Bestseller', images: [], specs: { power: '6 kW peak', topSpeed: '45 mph', range: '40 mi', weight: '110 lb', battery: '60V 38.5Ah' },
  ...
  { slug: 'sur-ron-ultra-bee-hp', name: 'Sur-Ron Ultra Bee HP', price: 8999, brand: 'sur-ron', category: 'adult-electric-dirt-bikes', badge: 'Flagship', images: [], specs: { power: '12.5 kW peak', topSpeed: '56 mph', range: '55 mi', weight: '187 lb', battery: '74V 55Ah' },
  ...
  { slug: 'sur-ron-hyper-bee', name: 'Sur-Ron Hyper Bee', price: 3699, brand: 'sur-ron', category: 'youth-electric-dirt-bikes', badge: '', images: [], specs: { power: '11 kW peak', topSpeed: '50 mph', range: '56 mi', weight: '116 lb', battery: '72V 46Ah' },
  ...
  { slug: 'sur-ron-storm-bee', name: 'Sur-Ron Storm Bee', price: 8500, brand: 'sur-ron', category: 'electric-motocross-bikes', badge: '', images: [], specs: { power: '22.5 kW peak', topSpeed: '68 mph', range: '68 mi', weight: '265 lb', battery: '104V 55Ah' },
  ...
  { slug: 'sur-ron-ultra-bee-mx', name: 'Sur-Ron Ultra Bee MX', price: 8500, brand: 'sur-ron', category: 'electric-motocross-bikes', badge: '', images: [], specs: { power: '12.5 kW peak', topSpeed: '56 mph', range: '55 mi', weight: '185 lb', battery: '74V 55Ah' },
  ...
  { slug: 'sur-ron-light-bee-l1e', name: 'Sur-Ron Light Bee L1e', price: 4500, brand: 'sur-ron', category: 'electric-trail-bikes', badge: 'Street-legal option', images: [], specs: { power: '6 kW peak', topSpeed: '28 mph (L1e)', range: '40 mi', weight: '112 lb', battery: '60V 38.5Ah' },
  ...
  { slug: 'talaria-sting-r', name: 'Talaria Sting R MX4', price: 5700, brand: 'talaria', category: 'adult-electric-dirt-bikes', badge: 'Popular', images: [], specs: { power: '8 kW peak', topSpeed: '53 mph', range: '50 mi', weight: '128 lb', battery: '60V 45Ah' },
  ...
  { slug: 'talaria-sting-mx5-pro', name: 'Talaria Sting MX5 Pro', price: 4800, brand: 'talaria', category: 'adult-electric-dirt-bikes', badge: '', images: [], specs: { power: '8 kW peak', topSpeed: '55 mph', range: '55 mi', weight: '130 lb', battery: '60V 42Ah' },
  ...
  { slug: 'talaria-sting-xxx', name: 'Talaria Sting XXX', price: 6649, brand: 'talaria', category: 'electric-motocross-bikes', badge: '', images: [], specs: { power: '10.5 kW peak', topSpeed: '60 mph', range: '55 mi', weight: '132 lb', battery: '60V 45Ah' },
  ...
  { slug: 'talaria-sting-mx3', name: 'Talaria Sting MX3', price: 3200, brand: 'talaria', category: 'youth-electric-dirt-bikes', badge: 'Value', images: [], specs: { power: '5 kW peak', topSpeed: '45 mph', range: '40 mi', weight: '110 lb', battery: '60V 38Ah' },
  ...
  { slug: 'stark-varg-ex', name: 'Stark Varg EX', price: 12900, brand: 'stark-future', category: 'electric-motocross-bikes', badge: 'Race-spec', images: [], specs: { power: '60 kW (80 hp) peak', topSpeed: '~75 mph', range: '~6 hrs riding', weight: '265 lb', battery: '6.5 kWh' },
  ...
  { slug: 'stark-varg-sm', name: 'Stark Varg SM', price: 12995, brand: 'stark-future', category: 'electric-trail-bikes', badge: 'New', images: [], specs: { power: '60 kW (80 hp) peak', topSpeed: '~80 mph', range: '~6 hrs riding', weight: '265 lb', battery: '6.5 kWh' },
  ...
  { slug: 'ktm-sx-e5', name: 'KTM SX-E 5', price: 5449, brand: 'ktm', category: 'youth-electric-dirt-bikes', badge: '', images: [], specs: { power: '5 kW peak', topSpeed: 'adjustable', range: '~2 hrs', weight: '87 lb', battery: '907 Wh' },
  ...
  { slug: 'ktm-sx-e2', name: 'KTM SX-E 2', price: 3199, brand: 'ktm', category: 'youth-electric-dirt-bikes', badge: '', images: [], specs: { power: '2 kW peak', topSpeed: 'adjustable', range: '~1.5 hrs', weight: '70 lb', battery: '519 Wh' },
  ...
  { slug: 'stacyc-18e-drive', name: 'STACYC 18eDRIVE', price: 1049, brand: 'stacyc', category: 'youth-electric-dirt-bikes', badge: 'Kids', images: [], specs: { power: '250 W', topSpeed: '13 mph', range: '30-60 min', weight: '19 lb', battery: '20V Li-ion' },
  ...
  { slug: 'stacyc-20e-drive', name: 'STACYC 20eDRIVE', price: 1199, brand: 'stacyc', category: 'youth-electric-dirt-bikes', badge: 'Kids', images: [], specs: { power: '250 W', topSpeed: '17 mph', range: '30-60 min', weight: '21 lb', battery: '20V Li-ion' },
  ...
  { slug: 'razor-mx650', name: 'Razor MX650', price: 599, brand: 'razor', category: 'youth-electric-dirt-bikes', badge: 'Entry', images: [], specs: { power: '650 W', topSpeed: '17 mph', range: '10 mi', weight: '98 lb', battery: '36V SLA' },
  ...
  { slug: 'e-ride-pro-ss3', name: 'E-Ride Pro SS3', price: 3499, brand: 'e-ride-pro', category: 'adult-electric-dirt-bikes', badge: '', images: [], specs: { power: '12 kW peak', topSpeed: '50 mph', range: '62 mi', weight: '150 lb', battery: '72V 40Ah' },
